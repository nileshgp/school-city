...
@Component({
  selector: 'app-mathtest1',
  templateUrl: './mathtest1.component.html',
  styleUrls: ['./mathtest1.component.css']
})


export class Mathtest1Component implements OnInit, OnDestroy {
  tests: Test[];
    ...
    .subscribe(
      (tests: Test[]) => {
        ...
        for (i = 0; i < (tests).length; i++) {
          eTests.push([tests[i].mathTest1]);
          studentScoresArray.push({name: tests[i].student, score: Number(tests[i].mathTest1)});
        }
