...
@Component({
  selector: 'app-sciencetest1',
  templateUrl: './sciencetest1.component.html',
  styleUrls: ['./sciencetest1.component.css']
})


export class Sciencetest1Component implements OnInit, OnDestroy {
  tests: Test[];
    ...
    .subscribe(
      (tests: Test[]) => {
        ...
        for (i = 0; i < (tests).length; i++) {
          eTests.push([tests[i].scienceTest1]);
          studentScoresArray.push({name: tests[i].student, score: Number(tests[i].scienceTest1)});
        }
