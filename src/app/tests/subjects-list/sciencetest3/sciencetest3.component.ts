...
@Component({
  selector: 'app-sciencetest3',
  templateUrl: './sciencetest3.component.html',
  styleUrls: ['./sciencetest3.component.css']
})


export class Sciencetest3Component implements OnInit, OnDestroy {
  tests: Test[];
    ...
    .subscribe(
      (tests: Test[]) => {
        ...
        for (i = 0; i < (tests).length; i++) {
          eTests.push([tests[i].scienceTest3]);
          studentScoresArray.push({name: tests[i].student, score: Number(tests[i].scienceTest3)});
        }
