...
@Component({
  selector: 'app-sciencetest2',
  templateUrl: './sciencetest2.component.html',
  styleUrls: ['./sciencetest2.component.css']
})


export class Sciencetest2Component implements OnInit, OnDestroy {
  tests: Test[];
    ...
    .subscribe(
      (tests: Test[]) => {
        ...
        for (i = 0; i < (tests).length; i++) {
          eTests.push([tests[i].scienceTest2]);
          studentScoresArray.push({name: tests[i].student, score: Number(tests[i].scienceTest2)});
        }
