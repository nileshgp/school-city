...
@Component({
  selector: 'app-mathtest3',
  templateUrl: './mathtest3.component.html',
  styleUrls: ['./mathtest3.component.css']
})


export class Mathtest3Component implements OnInit, OnDestroy {
  tests: Test[];
    ...
    .subscribe(
      (tests: Test[]) => {
        ...
        for (i = 0; i < (tests).length; i++) {
          eTests.push([tests[i].mathTest3]);
          studentScoresArray.push({name: tests[i].student, score: Number(tests[i].mathTest3)});
        }
