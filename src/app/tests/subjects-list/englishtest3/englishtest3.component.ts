...
@Component({
  selector: 'app-englishtest3',
  templateUrl: './englishtest3.component.html',
  styleUrls: ['./englishtest3.component.css']
})


export class Englishtest3Component implements OnInit, OnDestroy {
  tests: Test[];
    ...
    .subscribe(
      (tests: Test[]) => {
        ...
        for (i = 0; i < (tests).length; i++) {
          eTests.push([tests[i].englishTest3]);
          studentScoresArray.push({name: tests[i].student, score: Number(tests[i].englishTest3)});
        }
